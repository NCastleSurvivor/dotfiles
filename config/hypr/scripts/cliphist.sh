...
clip_h=$(cat $HOME/.config/rofi/config.rasi | awk '/window {/,/}/' | awk '/height:/ {print $2}' | awk -F "%" '{print $1}')
clip_w=$(cat $HOME/.config/rofi/config.rasi | awk '/window {/,/}/' | awk '/width:/ {print $2}' | awk -F "%" '{print $1}')
